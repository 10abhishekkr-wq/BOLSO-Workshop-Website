        ...
        <div class="container registration-grid">
            ...
            <aside class="registration-aside">
                <div class="aside-sticky">
                    ...
                    <a class="text-link dark-link" href="https://wa.me/<?= urlencode(bolso_config('whatsapp')) ?>" target="_blank" rel="noopener">Talk to BOLSO <i class="bi bi-arrow-up-right"></i></a>
                </div>
            </aside>
        </div>
    </section>
